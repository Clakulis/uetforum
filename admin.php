...
<body class="w3-theme-l5">
  <div class="w3-top">
    ...
    <!-- khung đăng bài -->
    <div class="w3-container w3-content" style="width:80%;max-width:1400px;margin-top:80px;min-height:81vh" id="page-container">
      <div class="w3-row" style="height: 600px;">
        ...
        <div class="w3-col m9" style="width: 100%;padding: 50px auto">
          <div style="width:100%;text-align:center">
            <img src="uploads/uet.png" style="height:600px; width:600px" alt="">
          </div>
        </div>
      </div>
    </div>
